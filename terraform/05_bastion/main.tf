# 05_bastion — main.tf
# Creates the Bastion host for SSH access into the private VPC/EKS API.
# Installs AWS CLI, Helm, and kubectl via shared/scripts/bastion_user_data.sh.
...
resource "aws_instance" "bastion_host" {
  ...
  user_data              = file("${path.module}/../shared/scripts/bastion_user_data.sh")
